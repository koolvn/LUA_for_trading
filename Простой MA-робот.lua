...
3.Робот ждет, пока закроется позичия по Стоп-лоссу, либо Тейк-профиту, после чего переходит к пункту №1
